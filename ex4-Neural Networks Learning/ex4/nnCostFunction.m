...
J = J + (sum_theta1 + sum_theta2)* lambda/(2*m);
...
for i  =1:m
   %step 1
    a1 = X(i,:);  %a1=x,5000(1)*401, theta1--25*401
    %z2 = theta1*a1, a2=g(z2),add a2[0]
    z2 = Theta1*a1';  %z2--25*1
    a2 = sigmoid(z2); %a2--25*1
    a2 = [1;a2];  %a2--26*1
    %z3 = theta2*a2, a3=g(z3)=h_theta, theta2--10*26
    z3 = Theta2*a2; %z3--10*1
    a3 = sigmoid(z3); %a3--10*1
    
    %step 2
    yi = yk(:,i); %yk--10*5000, yi--10*1
    ...
    %step 4
    delta2 = delta2(2:end,:);   %delta2--25*1
    dt2 = delta3 * a2';  %dt2--10*26
    dt1 = delta2 * a1;  %dt1--25*401
